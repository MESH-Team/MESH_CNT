...
! the top width calculation needs to check
    ...
    !print*, k,lftBnkMann,rmanning_main,rgtBnkMann,leftBnkX,rghtBnkX,timesDepth,num_reach
    !pause 1010
...
!     Open data file
    ...
    write(file_num,'(i4.4)')k
        !print*, num_reach, file_num


      !leftBnkX= 2342.
      !rghtBnkX= 2523.5
      !lftBnkMann=rmanning_main
      !rgtBnkMann=rmanning_main
      startFound = 0
      endFound = 0
...
400   close(11)
      ...
      allXcs(6:totalNodes(2)+1,2) = allXcs(5:totalNodes(2),2)
